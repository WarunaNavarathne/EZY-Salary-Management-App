...
function Register() {
    ...
    async function Registration(e) {
        ...
        try {
            const response = await axios.post("http://localhost:5000" + "/admin/register", userReg);
            ...
            <MDBRow style={{ marginTop: '1%', marginBottom: '10%', width: '99%' }}>
                ...
                <MDBCol sm='5'>
                    <MDBCard className="border-0 shadow-0">
                        <MDBCardImage style={{ width: '200', height: '508px', marginTop: '111px' }} position='top' alt='...' src='https://www.pngitem.com/pimgs/m/274-2748802_transparent-tech-support-icon-png-admin-login-images.png' />
                    </MDBCard>
                </MDBCol>
                <MDBCol sm='6'>
                    <MDBCard className="border-0 shadow-0 p-5">
                        <MDBCardBody className="pt-5 mt-3 text-left">
                            <div className="bg-light p-4">
                                <center><h2 className="text-uppercase">Admin Register</h2></center>
                                <br />
                                <div class="mb-3">
