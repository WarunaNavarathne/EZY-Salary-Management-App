            ...
            <MDBRow style={{ marginBottom: '10%', width: '99%' }}>
                ...
                <MDBCol sm='6'>
                    <MDBCard className="border-0 shadow-0">
                        <MDBCardImage style={{ width: '65%', marginTop: '318px' }} position='top' alt='...' src='https://www.pngkit.com/png/detail/518-5186670_login-icon-login-signup-icon-png.png' />
                    </MDBCard>
                </MDBCol>
                    ...
                    <MDBCard className="border-0 shadow-0 p-5" >
                        <MDBCardBody className="pt-5 mt-3 text-left">
                            <div className="bg-light p-4" >
                                <center><h1 className="text-uppercase">Log In</h1></center>
                                <br />
                                <div class="mb-3">
